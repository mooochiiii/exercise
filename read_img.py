...
def main():
    X,y = read_img_data('/Users/Hoa/Library/Mobile Documents/com~apple~CloudDocs/kagglecatsanddogs_5340/PetImages','Cat', (32,32))
    X_dog, y_dog = read_img_data('/Users/Hoa/Library/Mobile Documents/com~apple~CloudDocs/kagglecatsanddogs_5340/PetImages','Dog', (32,32))
    X.extend(X_dog)
    y.extend(y_dog)
    X = np.array(X)
